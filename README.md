...
Latest version: `1.41.8` (`12/11/2025`)

The 1.41.8 version includes many enhancements including the advanced API spec HTTP probing capabilities.
...
- [Mac](https://github.com/mintoolkit/mint/releases/download/1.41.8/dist_mac.zip),
- [Mac M1](https://github.com/mintoolkit/mint/releases/download/1.41.8/dist_mac_m1.zip),
- [Linux](https://github.com/mintoolkit/mint/releases/download/1.41.8/dist_linux.tar.gz),
- [Linux ARM](https://github.com/mintoolkit/mint/releases/download/1.41.8/dist_linux_arm.tar.gz),
- [Linux ARM64](https://github.com/mintoolkit/mint/releases/download/1.41.8/dist_linux_arm64.tar.gz)
