...
- `--command-params-file` -  JSON file with all command parameters - the JSON file expects snake case formatted commands example `--docker-config-path` would be `docker_config_path`
